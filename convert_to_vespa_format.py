# pylint: disable=invalid-name missing-function-docstring consider-using-f-string line-too-long missing-module-docstring unspecified-encoding
#! /usr/bin/env python3
...
def convert_file(output, file_name, docids, click_map):
    ...
    with io.open(file_name, "r", encoding="utf-8") as f:
        ...
        for line in reader:
            ...
            doc["fields"][
                "date"
            ] = generate_random_date()  # data set does not include a publish date
